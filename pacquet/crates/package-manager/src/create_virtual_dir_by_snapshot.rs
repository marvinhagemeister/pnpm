use crate::{
    ...
    package_instance_cache::{PackageInstanceEntry, try_populate_from_package_instance},
};
...
pub struct CreateVirtualDirBySnapshot<'a> {
    ...
    pub(crate) package_instance: Option<PackageInstanceEntry>,
...
impl<'a> CreateVirtualDirBySnapshot<'a> {
    ...
    pub fn run<Reporter: self::Reporter>(self) -> Result<(), CreateVirtualDirError> {
        ...
        let populated_from_instance = package_instance.as_ref().is_some_and(|instance| {
